...
namespace EDSL_API.Controllers
{
    public class SeasonsController : ApiController
    {
        ...
        public IHttpActionResult PostSeason(Season season)
        {
            ...
            {
                if (SeasonExists(season.seasonCode))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = season.seasonCode }, season);
        }
        ...
        {
            return db.Seasons.Count(e => e.seasonCode == id) > 0;
        }
    }
}