...
namespace EDSL_API.Controllers
{
    public class PlayersController : ApiController
    {
        ...
        public IHttpActionResult PostPlayer(Player player)
        {
            ...
            {
                if (PlayerExists(player.playerCode))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = player.playerCode }, player);
        }
        ...
        {
            return db.Players.Count(e => e.playerCode == id) > 0;
        }
    }
}